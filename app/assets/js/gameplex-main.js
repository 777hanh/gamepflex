...
$(document).ready(() => {
    ...
    $(document).on('click', function (event) {
        // navbar toggle hide
        if (
            !$(event.target).closest('.navbar-toggle-item, .navbar-toggle-btn')
                .length
        ) {
        ...
        // search bar hide
        if (
            !$(event.target).closest('.search-bar, .search-toggle-btn').length
        ) {
        ...
        // profile popup hide
        if (
            !$(event.target).closest('.user-account-popup, .header-profile')
                .length
        ) {
        ...
        // chat list hide
        if (
            !$(event.target).closest('.chat-list-area, .chat-list-toggle-btn')
                .length
        ) {
    ...
    $('.accordion-single .acc-header-area').click(function () {
        if ($(this).closest('.accordion-single').hasClass('active')) {
            ...
            $('.acc-content-area')
                .not($(this).next('.acc-content-area'))
                .slideUp();
