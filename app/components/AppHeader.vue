<template>
  <header
    class="app-header w-full relative"
  ...
  >
    <div class="py-3 px-4 md:px-6 lg:px-8">
      <div class="flex items-center justify-between w-full">
        ...
        <div class="flex items-center gap-4 header-left" data-header-left>
          <UButton
            variant="ghost"
          ...
          <NuxtLink to="/" class="flex items-center gap-2">
            <UIcon name="i-tabler-brand-game" class="text-2xl text-primary" />
        ...
        <nav
          :class="[
            'lg:flex items-center gap-6 ml-10 main-nav',
            isMenuOpen
              ? 'absolute top-16 left-0 right-0 bg-gray-900 p-4 z-50'
              : 'hidden',
          ]"
          data-main-nav
        >
          <ul class="flex flex-col lg:flex-row gap-4 lg:gap-6">
            ...
            <li>
              ...
              >
                ...
                >
                  Tournament
                  <UIcon name="i-tabler-chevron-down" class="text-sm" />
                </button>
              </UDropdown>
            </li>
            <li>
              <a
                ...
                @click.prevent="scrollToSection('featured-games')"
                >Games</a
              >
            </li>
            <li>
            ...
            <li>
              ...
              >
                ...
                >
                  Pages <UIcon name="i-tabler-chevron-down" class="text-sm" />
                </button>
              </UDropdown>
            </li>
          </ul>
        ...
        <!-- Right: Actions -->
        <div class="flex items-center gap-3 header-actions" data-header-actions>
          <UButton
            variant="ghost"
            icon="i-tabler-bell"
            class="rounded-full"
            ...
            >
              <div class="flex items-center gap-2">
                <img
                  ...
                  height="40"
                />
                <span class="hidden lg:inline">David Malan</span>
                <UIcon name="i-tabler-chevron-down" class="hidden lg:block" />
              </div>
            </UButton>
            <div
              v-if="isProfileOpen"
              class="absolute top-full right-0 mt-2 bg-gray-900 p-2 rounded min-w-40 z-10"
            >
              <NuxtLink
                to="/profile"
    ...
    <div
      ...
      class="absolute right-4 top-16 bg-gray-900 p-4 rounded shadow-lg z-50 w-80"
    >
      <div class="space-y-4">
        <div
          v-for="notification in notifications"
          :key="notification.id"
          class="flex items-center gap-3 p-2 hover:bg-gray-800 rounded"
        >
          <UAvatar
...
const pageItems = [
  [
    { label: "FAQ", icon: "i-tabler-help", click: () => navigateTo("/faq") },
    {
      label: "Terms",
...
onMounted(() => {
  ...
  if (!prefersReduced) {
    ...
    tl.from("[data-header]", { y: -60, opacity: 0, duration: 0.6 }, 0)
      .from("[data-header-left]", { x: -30, opacity: 0, duration: 0.5 }, 0.1)
      .from(
        "[data-main-nav] li",
