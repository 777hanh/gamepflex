    ...
    <div class="filters">
      ...
      <div class="filter-options">
        <select v-model="gameFilter">
          ...
          <option v-for="game in gameOptions" :key="game" :value="game">{{ game }}</option>
        </select>
      ...
      >
        ...
        <div class="tournament-info">
          ...
          <div class="tournament-position" v-if="tournament.position">
            <div class="position-badge" :class="getPositionClass(tournament.position)">
              {{ getPositionText(tournament.position) }}
            </div>
          </div>
        </div>
        <div class="tournament-actions">
          <NuxtLink :to="`/tournaments/${tournament.id}`" class="btn-details">
            Chi tiết
          </NuxtLink>
        </div>
      </div>
...
const filteredTournaments = computed(() => {
  return props.tournaments.filter((tournament: any) => {
    ...
    const matchesGame = !gameFilter.value || tournament.game === gameFilter.value;
