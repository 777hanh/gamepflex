    ...
    >
        ...
        <div class="position-relative container">
            <div class="section-header mb-5 text-center">
                <h2 class="display-5 fw-bold mb-3 text-white">Top Players</h2>
            ...
            <ClientOnly>
                ...
                >
                    <SwiperSlide v-for="(p, i) in players" :key="p.id">
                        ...
                        >
                            <div
                                class="magnetic-inner player-inner d-flex flex-column h-100 p-4"
                            >
                                <div
                                ...
                                >
                                    ...
                                    <NuxtImg
                                        ...
                                        width="72"
                                        height="72"
                                        class="rounded-circle player-avatar flex-shrink-0"
                                    />
                                    <div>
                                ...
                                <div class="mt-auto">
                                    <NuxtLink
                                        ...
                                        class="btn btn-outline-light btn-sm magnetic d-flex align-items-center justify-content-center w-100 gap-2"
                                    >
